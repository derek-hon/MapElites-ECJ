...
public abstract class MapElitesSpecies implements Prototype
{
    ...
    public MapElitesBreedingPipeline pipe_prototype;
    ...
    public Object clone()
    {
        try
        {
            ...
            myobj.pipe_prototype = (MapElitesBreedingPipeline) pipe_prototype.clone();
            return myobj;
        }
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        pipe_prototype = (MapElitesBreedingPipeline) (
                state.parameters.getInstanceForParameter(
                        base.push(P_PIPE),def.push(P_PIPE),MapElitesBreedingPipeline.class));
        ...
        i_prototype = (Elite)(state.parameters.getInstanceForParameter(
